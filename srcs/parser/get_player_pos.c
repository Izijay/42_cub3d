...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/06/06 13:29:58 by ranuytte          #+#    #+#             */
/*   Updated: 2022/06/06 13:33:49 by ranuytte         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "cub3d.h"

static void	save_player_dir(t_data *data, char dir, int i, int j)
{
	if (dir == 'S')
		data->player_dir = 0;
	else if (dir == 'N')
...
static void	return_error(t_data *data, int player)
{
	if (player == 0)
